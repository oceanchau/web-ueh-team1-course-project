...
<head>
    ...
    <title>LightCart - eCommerce HTML Template</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="LightCart is a beautiful eCommerce HTML template specially designed for multipurpose shops & online stores selling products. Most Loved by Developers to build a store website easily.">
            ...
            <div class="row min-vh-100 justify-content-center align-items-center">
                ...
                <div class="offset-lg-1 col-lg-10  py-8 py-xl-0">
                    <div class=" mb-10 mb-xxl-0">
                        <!-- img -->
                        <a href="/"> <img src="assets/images/logo/freshcart-logo.svg" alt=""></a>
                    </div>
