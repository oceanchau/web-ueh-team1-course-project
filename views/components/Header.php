                ...
                <div class="col-xxl-6 col-lg-5 d-none d-lg-block">
                    ...
                    <form method="get">
                        <div class="input-group ">
                            <input class="form-control rounded-3" type="search" placeholder="Search for products"
        ...
        <div class="modal-content p-4">
            ...
            <div class="modal-body">
                <form method="post">
                    ...
                    <button type="submit" name="submitLogin" id="submitLogin" class="btn btn-primary">Sign In</button>
                </form>
            </div>
    ...
    <div class="offcanvas-body">
        ...
        <div class="">
            ...
            <div class="alert alert-danger p-2" role="alert">
                You’ve got FREE delivery. Start <a href="?controller=shop&action=checkout" class="alert-link">checkout
                    now!</a>
            </div>
            ...
            <div class="d-flex justify-content-between mt-4">
                <a class="btn btn-outline-primary" data-bs-dismiss="offcanvas" aria-label="Close">Continue Shopping</a>
                <a href="?controller=shop&action=checkout"
                   class="btn btn-primary d-flex justify-content-between align-items-center" type="submit">
